...
3. Copilot reads the instructions in `.github/copilot-instructions.md` and the slide authoring rules in `.github/instructions/` — then fills in `src/index.html` with a complete set of slides.
